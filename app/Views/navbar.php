                ...
                <div class="space-y-4">
                    ...
                    ?>
                        <div class="flex items-center space-x-3 p-3 rounded-lg bg-blue-50 mb-2">
                            <div class="w-10 h-10 flex items-center justify-center bg-blue-100 border border-blue-500 rounded-full text-blue-700 font-bold text-lg">
                                <?= $initials ?>
                            </div>
                            <span class="text-gray-700 font-medium"><?= $firstName . ' ' . $lastName ?></span>
                        </div>

...
<nav
    ...
    <div class="flex items-center space-x-2">
        <a href="index.php" class="font-bold cursor-pointer text-blue-500 text-2xl">SheyWe <span
                class="text-black">Community Hospital</span></a>
    </div>
    ...
    <div class="hidden  md:flex items-center space-x-4">
        ...
        <button id="profileMenuBtn" class="relative focus:outline-none">
            <img src="/storage/uploads/doctor1.png" alt="Profile"
                class="w-8 h-8 border border-blue-500 cursor-pointer rounded-full object-cover">
        </button>
        <!-- Profile Modal -->
        <div id="profileModal"
            class="absolute right-0 top-15 mr-2 w-56 bg-white shadow-lg cursor-pointer rounded-lg border border-gray-200 z-50 hidden">
            <ul class="py-2">
                ...
                <li><a href="#" class="block px-4 py-2 text-gray-700 hover:bg-blue-50">Logout</a></li>
            </ul>
        </div>

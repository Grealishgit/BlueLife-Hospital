...
<nav
    class="bg-white fixed top-0 w-full text-white z-50 p-2 shadow-sm shadow-gray-600 flex items-center justify-between">
    <div class="flex flex-col gap-1 items-center space-x-2">
        <a href="index.php" class="font-bold  cursor-pointer  text-blue-500 text-xl">SheyWe </a>
        <hr class="border-blue-600 w-full" />
        <h4 class="text-black font-bold cursor-pointer text-sm md:block hidden">Community Hospital</h4>
    </div>
    ...
    <div id="mobileMenu"
        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-8">
                <span class="font-bold text-blue-500 text-xl">Shweye<span class="text-black ml-2">
                        Hospital</span></span>
            ...
            <div class="border-t pt-6">
                <div class="space-y-4">
                    ...
                    <?php else:
                        ...
                        $initials = strtoupper(substr($user['first_name'], 0, 1) . substr($user['last_name'], 0, 1));
                    ?>
                    <div class="flex items-center space-x-3 p-3 rounded-lg bg-blue-50 mb-2">
                        <div
                            class="w-10 h-10 flex items-center justify-center bg-blue-100 border border-blue-500 rounded-full text-blue-700 font-bold text-lg">
                            <?= $initials ?>
                        </div>
                        <span class="text-blue-700 font-medium"><?= $firstName . ' ' . $lastName ?></span>
                    </div>
                    <div>
                        <a href="profile.php"
                            class="block w-full text-center bg-blue-400 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-600 transition-colors mb-2">
                            My Profile
                        </a>
                        <a href="myappointments.php"
                            class="block w-full text-center bg-blue-400 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-600 transition-colors">
                            My Appointments
                        </a>
                    </div>
                    <a href="#" onclick="logoutUser()"
                        class="block w-full text-center bg-red-500 text-white py-3 px-6 rounded-lg font-semibold hover:bg-red-600 transition-colors">
                        Logout
                    </a>
                    <?php endif; ?>
                </div>

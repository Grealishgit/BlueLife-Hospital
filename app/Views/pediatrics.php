...
<head>
    ...
    <title>Pediatrics - Sheywe Community Hospital</title>
...
<body class="font-inter bg-gradient-to-br from-blue-50 via-white to-purple-50 min-h-screen">
        ...
        <div class="relative max-w-6xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-xl mb-8 text-blue-100">Comprehensive healthcare for children from newborns to
                        teenagers, with specialized care that puts your child's comfort first.</p>
    ...
    <section class="py-20">
        <div class="max-w-6xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600">From newborns to teenagers, we provide age-appropriate care for every
                    child.</p>
            </div>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                <div class="text-center group hover:transform hover:scale-105 transition-all">
                    <div
                        class="w-24 h-24 bg-gradient-to-br from-pink-100 to-purple-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:shadow-lg transition-shadow">
                ...
                <div class="text-center group hover:transform hover:scale-105 transition-all">
                    <div
                        class="w-24 h-24 bg-gradient-to-br from-blue-100 to-green-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:shadow-lg transition-shadow">
                        <span class="text-4xl">🧒</span>
                    </div>
                ...
                <div class="text-center group hover:transform hover:scale-105 transition-all">
                    <div
                        class="w-24 h-24 bg-gradient-to-br from-yellow-100 to-orange-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:shadow-lg transition-shadow">
                        <span class="text-4xl">👧</span>
                    </div>
                ...
                <div class="text-center group hover:transform hover:scale-105 transition-all">
                    <div
                        class="w-24 h-24 bg-gradient-to-br from-purple-100 to-pink-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:shadow-lg transition-shadow">
                        <span class="text-4xl">🧑‍🎓</span>
                    </div>
    ...
    <section id="services" class="py-20 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600">Comprehensive care designed specifically for children's unique
                    healthcare needs.</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <button class="text-blue-600 font-semibold hover:text-blue-700 transition-colors">Learn More
                        →</button>
                </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                foreach ($specialties as $specialty): ?>
                    <div
                        ...
                        <h3
                            class="font-semibold text-gray-800 group-hover:text-<?php echo $specialty['color']; ?>-600 transition-colors">
    ...
    <section id="doctors" class="py-20 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600">Experienced pediatricians who understand children and make healthcare
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php foreach ($pediatricsDoctors as $doctor): ?>
                    <div
                        ...
                        <div
                            class="h-64 bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 flex items-center justify-center">
                            <div
                                class="w-32 h-32 bg-gradient-to-br from-blue-200 to-purple-200 rounded-full flex items-center justify-center">
                                <span
                                    class="text-2xl font-bold text-blue-700"><?php echo strtoupper(substr($doctor['name'], 0, 2)); ?></span>
                            </div>
                        </div>
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <?php foreach ($doctor['expertise'] as $skill): ?>
                                        <span
                                            class="bg-blue-100 text-blue-700 px-2 py-1 rounded-full text-xs"><?php echo $skill; ?></span>
                                    <?php endforeach; ?>
                                </div>
                            </div>
    ...
    <section class="py-20">
        <div class="max-w-6xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600">We've designed our spaces to be welcoming and comfortable for children
                    and families.</p>
            </div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Bright, engaging spaces that help children feel comfortable and
                                    entertained.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Toys, books, and comfort items to help reduce anxiety during
                                    visits.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Comfortable spaces for families to stay with their children
                                    during treatment.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Specially trained staff to help children cope with medical
                                    procedures.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl p-8">
                        ...
                        <p class="text-gray-600 text-center">
                            We use play therapy and entertainment to help children feel at ease during their medical
                            visits.
                        </p>
                    </div>
                </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-6xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600">Helpful information and tools to support your child's health and
                    development.</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 text-center">
                    ...
                    <p class="text-gray-600 mb-6">Track your child's growth and development with our interactive charts
                        and tools.</p>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 text-center">
                    ...
                    <p class="text-gray-600 mb-6">Stay up-to-date with recommended vaccinations for your child's age
                        group.</p>
                    <button class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                        View Schedule
                    </button>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 text-center">
                    ...
                    <p class="text-gray-600 mb-6">Practical advice for caring for sick children and managing common
    ...
    <section class="py-20 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-xl mb-8 text-blue-100">Schedule an appointment with our pediatric specialists who understand
                children's unique needs.</p>

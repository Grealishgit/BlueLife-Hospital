...
<div id="loginModal"
    ...
    <div class="bg-white rounded-md shadow-lg w-full max-w-sm p-6 relative">
        <button onclick="closeModal()"
            class="absolute top-2 right-4 cursor-pointer text-red-500 hover:text-red-700">&times;</button>
        ...
        <div id="loginForm">
            ...
            <form>
                <input type="email" placeholder="Your Email" class="w-full mb-3 px-3 py-2 border rounded" required>
                <input type="password" placeholder="Your Password" class="w-full mb-3 px-3 py-2 border rounded"
                    required>
        ...
        <div id="signupForm" class="hidden">
            ...
            <form>
                <input type="text" placeholder="Name" class="w-full mb-3 px-3 py-2 border rounded" required>
                <input type="email" placeholder="Your Email" class="w-full mb-3 px-3 py-2 border rounded" required>
                <input type="password" placeholder="Your Password" class="w-full mb-3 px-3 py-2 border rounded"
                    required>
                <button type="submit"

...
<div class="consultations-admin-content">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Manage and view all consultation requests with comprehensive administrative
            controls.</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex flex-col lg:flex-row gap-4">
            <!-- Search -->
            <div class="flex-1">
                <label for="searchConsultations" class="block text-sm font-medium text-gray-700 mb-2">Search
                    Consultations</label>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody id="consultationsTableBody" class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="consultation-row hover:bg-gray-50" data-status="<?php echo $consultation['status']; ?>"
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo htmlspecialchars($consultation['email']); ?>
                            </div>
                            <div class="text-sm text-gray-500"><?php echo htmlspecialchars($consultation['phone']); ?>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ...
                            <div class="text-gray-500">
                                <?php echo date('g:i A', strtotime($consultation['preferred_time'])); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span
                                class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo getStatusBadgeClass($consultation['status']); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <button
                                onclick="updateStatus(<?php echo $consultation['id']; ?>, '<?php echo $consultation['status']; ?>')"
